...
#include "route.hpp"
#include "../../AP-F03-A6-810101611/interface.hpp"
...
public:
    ...
    virtual Response* callback(Request* req, interface &manager) = 0;
};

class ShowFile : public RequestHandler {
public:
    ShowFile(const std::string& filePath, const std::string& fileType);
    Response* callback(Request* req, interface &manager) override;
